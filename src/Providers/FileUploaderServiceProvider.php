...
class FileUploaderServiceProvider extends ServiceProvider
{
    public function register(): void
    {
        ...
        // Core type-hints in controllers/commands resolve to the Laravel-wired services.
        $this->app->bind(FileUploader::class, fn (Application $app) => $app->make(FileUpload::class));
        $this->app->bind(FileManager::class, fn (Application $app) => $app->make(FileWidget::class));
    }
    ...
    protected function registerPublishing(): void
    {
        ...
        $this->publishes([
            __DIR__.'/../../resources/assets/js/file-uploader.umd.js' => public_path('vendor/file-uploader/file-uploader.umd.js'),
